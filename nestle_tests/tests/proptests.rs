...
mod test {
    ...
    fn full_bytes_number_strategy() -> impl Strategy<Value = FullByteNumbers> {
        (
            ...
            .prop_map(|(first, second, third, fourth, fifth, sixth, seventh)| {
                FullByteNumbers(first, second, third, fourth, fifth, sixth, seventh)
            })
    }
    ...
    fn full_tuples_with_numbers_strategy() -> impl Strategy<Value = FullTupleWithNumbers> {
        (
            ...
            .prop_map(|(first, second, third, fourth, fifth)| {
                FullTupleWithNumbers(NumberTuple(first, second), third, fourth, fifth)
            })
    }
    ...
    fn not_full_bytes_number_strategy() -> impl Strategy<Value = NotFullByteNumbers> {
        (
            ...
            .prop_map(|(first, second, third, fourth, fifth, sixth)| {
                NotFullByteNumbers(first, second, third, fourth, fifth, sixth)
            })
    }
    ...
    fn not_full_signed_unsigned_numbers_strategy(
    ) -> impl Strategy<Value = NotFullSignedUnsignedNumbers> {
        (any::<u16>(), any::<i32>())
    ...
    fn not_full_tuples_with_numbers_strategy() -> impl Strategy<Value = NotFullTuplesWithNumbers> {
        (
            double_unsigned_numbers_strategy(),
            any::<u16>(),
            any::<u8>(),
        )
    ...
    fn full_bool_strategy() -> impl Strategy<Value = FullBool> {
        (
            ...
            .prop_map(|(first, second, third, fourth, fifth, sixth, seventh)| {
                FullBool(first, second, third, fourth, fifth, sixth, seventh)
            })
    }
    ...
    fn bool_with_numbers_strategy() -> impl Strategy<Value = BoolWithNumbers> {
        (any::<bool>(), any::<u32>(), any::<bool>(), any::<i8>()).prop_map(
            |(first, second, third, fourth)| BoolWithNumbers(first, second, third, fourth),
        )
    }
    ...
    fn units_with_others_strategy() -> impl Strategy<Value = UnitsWithOthers> {
        (any::<bool>(), any::<u8>(), any::<i8>(), any::<i16>()).prop_map(
            |(first, second, third, fourth)| {
                UnitsWithOthers((), (), first, (), second, (), third, (), fourth)
            },
        )
    }
    ...
    {
        any::<u16>().prop_map(|first| SinglePrimitiveFieldStruct { field: first })
    }

    fn struct_several_primitive_fields_strategy(
    ) -> impl Strategy<Value = SeveralPrimitiveFieldsStruct> {
        (any::<char>(), any::<u16>(), any::<bool>()).prop_map(|(first, second, third)| {
            SeveralPrimitiveFieldsStruct {
                field1: first,
                field2: second,
                field3: third,
            }
    ...
    fn struct_single_struct_field_strategy() -> impl Strategy<Value = SingleStructFieldStruct> {
        struct_single_tuple_field_strategy()
            .prop_map(|value| SingleStructFieldStruct { field: value })
    }

    fn struct_several_different_fields_strategy(
    ) -> impl Strategy<Value = SeveralDifferentFieldsStruct> {
        (
            bird_names_strategy(),
            any::<u8>(),
            a_lot_of_units_strategy(),
            struct_single_primitive_field_strategy(),
            empty_strategy(),
            double_unsigned_numbers_strategy(),
        )
            .prop_map(|(first, second, third, fourth, fifth, sixth)| {
                SeveralDifferentFieldsStruct {
                    field1: first,
                    field2: second,
                    field3: third,
                    field4: fourth,
    ...
    fn diverse_zoo_strategy() -> impl Strategy<Value = DiverseZoo> {
        prop_oneof![
            ...
            not_full_signed_unsigned_numbers_strategy()
                .prop_map(DiverseZoo::NotFullSignedUnsignedNumbers),
            ...
            struct_single_primitive_field_strategy()
                .prop_map(DiverseZoo::SinglePrimitiveFieldStruct),
            ...
            struct_several_primitive_fields_strategy()
                .prop_map(DiverseZoo::SeveralPrimitiveFieldsStruct),
        ]
    }
